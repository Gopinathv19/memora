    ...
    <>
        ...
        <DataTable
          ...
          empty={{
            title: tenantFilter
              ...
              : "No applications yet",
            description:
              "An application belongs to one tenant, and the create form asks which.",
            action: (
              <Button variant="primary" onClick={() => setCreating(true)}>
                Create application
              </Button>
      ...
      {creating && (
        <CreateApplicationModal
          // The filter is a starting point, not a precondition: the form asks
          // for a tenant when none is filtered.
