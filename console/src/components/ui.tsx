...
const STATUS_TONE: Record<string, string> = {
  ...
  processing: "text-info bg-info-soft border-info/20",
...
export function Panel({
  ...
  return (
    <section className="rounded-lg border border-line bg-panel">
      {(title || actions) && (
        <header className="flex flex-wrap items-start justify-between gap-3 rounded-t-lg border-b border-line bg-surface px-4 py-2.5">
          <div>
            {title && (
